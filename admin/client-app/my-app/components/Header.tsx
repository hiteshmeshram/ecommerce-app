...
export const Header = ()=>{
    ...
    return ( 
        <div className="flex justify-between  py-4 px-4 mb-3 text-black font-semibold">
            <div className="text-xl flex items-center " >Mobile Shopify {session.data?.user?.name}
            ...
            <div className="text-xl ">
                <ul className="flex ">
                    <li className="mx-5 hover:border px-4 py-2 rounded-md hover:bg-slate-100 "><Link href='/home' >Home</Link></li>
                    <li className="mx-5 hover:border px-4 py-2 rounded-md hover:bg-slate-100"><Link href='/about'>About us</Link></li>
                    <li className="mx-5 hover:border px-4 py-2 rounded-md hover:bg-slate-100"><Link href='/cart'>Cart</Link></li>
                </ul>
            </div>
